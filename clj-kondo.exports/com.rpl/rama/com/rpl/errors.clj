...
(defn info-unverifiable-pobject!
      "Emits an info-level diagnostic for a $$-prefixed symbol that cannot be
  verified as declared in the current module scope."
      [pobject-name metadata]
      (api/reg-finding!
       {:message (format "Cannot verify that %s is declared in this module's scope" pobject-name)
